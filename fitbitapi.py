...
# this link to generate - https://dev.fitbit.com/build/reference/web-api/troubleshooting-guide/oauth2-tutorial/
...
def getMaxHeartRate():  
    ...
    print (f"maxHeartRate={maxheartrate}")
    return maxheartrate  
