    ...
    if request.method == 'POST':
        ...
        if monitor == "Yes":
            with open ("databaseUsers.txt", 'w') as file:
                ...
                file.write(f"cp={cp}\n")
                file.write(f"trestbps={trestbps}\n")
                file.write(f"chol={chol}\n")
                file.write(f"fbs={fbs}\n")
                file.write(f"restecg={restecg}\n")
                file.write(f"thalach={thalach}\n")
                file.write(f"exang={exang}\n")
                file.write(f"oldpeak={oldpeak}\n")
                file.write(f"slope={slope}\n")
                file.write(f"ca={ca}\n")
                file.write(f"thal={thal}\n")
                file.write(f"done=true\n")
                file.close()
                pass
